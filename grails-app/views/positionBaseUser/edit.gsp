		...
		<div class="col-lg-12 form-group">
			<div class="panel panel-default">
				<div class="panel-heading">
					...
					<g:hasErrors bean="${positionBaseUserInstance}">
						<ul class="errors" role="alert">
							<g:eachError bean="${positionBaseUserInstance}" var="error">
				...
				<div class="panel-body">
					<g:form url="[resource:positionBaseUserInstance,controller:'positionBaseUser', action:'update']" method="PUT" >
					<g:hiddenField name="version" value="${positionBaseUserInstance?.version}" />
