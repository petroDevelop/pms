	...
	<head>
		...
		<script>
			...
			function nameFormatter(value, row) {
				var str='<a href="${request.contextPath}/baseDepartment/show/'+row.id+'?from=underTeamList">'+row.name+'</a>';
				return str;
			}
			...
			function newWindow(){
				document.location.href="${createLink(controller: 'baseDepartment',action:'create')}?from=underTeamList";
			}
		</script>
	</head>
	<body>
	...
	<div >
		...
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active" >下属小队管理</li>
			</ol>
		</div><!--/.row-->

		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">下属小队管理</h1>
			</div>
		</div><!--/.row-->
				...
				<div class="panel panel-default">
					<g:form method="post">
						...
						<div class="panel-body">
							...
							<table id="baseDepartmentTable" data-toggle="table"  data-toolbar="#toolbar" data-url="${request.contextPath}/baseDepartment/underTeamJson"
