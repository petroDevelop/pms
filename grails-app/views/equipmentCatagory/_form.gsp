...
<div class="fieldcontain ${hasErrors(bean: equipmentCatagoryInstance, field: 'parent', 'error')} ">
	...
	<g:select id="parent" data-toggle="modal" href="#show" name="parent.id"  onclick="changeTree(this);" from="${com.petrodata.pms.equipment.EquipmentCatagory.list()}" optionKey="id"  value="${equipmentCatagoryInstance?.parent?.id}" class="form-control input-lg m-b-10"/>
