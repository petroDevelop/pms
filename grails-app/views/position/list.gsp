...
<head>
	...
	<script>
		...
		function editFormatter(value, row) {
			var str='<a href="${request.contextPath}/position/edit/'+row.id+'"><button class="btn btn-default margin" type="button"><span class="glyphicon glyphicon-edit"></span> &nbsp;<g:message code="default.button.edit.label" default="Edit" /></button></a>';
			return str;
		}
...
<div >
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header"><g:message code="position.label" default="Position" /></h1>
		</div>
	</div><!--/.row-->
