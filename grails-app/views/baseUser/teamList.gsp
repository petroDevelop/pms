	...
	<head>
		...
		<script>
			...
			function editFormatter(value, row) {
				var str='<a href="${request.contextPath}/baseUser/edit/'+row.id+'?from=teamList"><button class="btn btn-default margin" type="button"><span class="glyphicon glyphicon-edit"></span> &nbsp;<g:message code="default.button.edit.label" default="Edit" /></button></a>';
				return str;
			}
			...
			function newWindow(){
				document.location.href="${createLink(controller: 'baseUser',action:'create')}?from=teamList";
			}
		</script>
	</head>
	<body>
				...
				<div class="panel panel-default">
					<g:form method="post">
						...
						<div class="panel-body">
							...
							<table id="baseUserTable" data-toggle="table" data-toolbar="#toolbar"  data-url="${request.contextPath}/baseUser/teamListJson"
