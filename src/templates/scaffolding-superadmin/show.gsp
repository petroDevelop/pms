...
<html>
	...
	<body>
		...
		<div id="show-${domainClass.propertyName}" class="content scaffold-show" role="main">
			...
			<ol class="property-list ${domainClass.propertyName}">  <table class="table tile">
			...
			<g:form url="[resource:${propertyName}, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					...
					<g:link class="btn btn-info btn-sm m-t-10" action="edit"  id="\${${propertyName}?.id}" resource="\${${propertyName}}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
