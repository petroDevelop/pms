$(document).ready(function(){
    ...
    var settings =  '<a id="settings" href="#changeSkin" data-toggle="modal">' +
        ...
        '<a data-skin="skin-blur-violate" class="col-sm-2 col-xs-4 skin-violate-tip" href="">' +
        '</a>' +
        '<a data-skin="skin-blur-lights" class="col-sm-2 col-xs-4 skin-lights-tip" href="">' +
        '</a>' +
        '<a data-skin="skin-blur-city" class="col-sm-2 col-xs-4  skin-city-tip" href="">' +
        '</a>' +
        '<a data-skin="skin-blur-greenish" class="col-sm-2 col-xs-4 skin-greenish-tip" href="">' +
        '</a>' +
        '<a data-skin="skin-blur-night" class="col-sm-2 col-xs-4 skin-night-tip" href="">' +
        '</a>' +
        '<a data-skin="skin-blur-blue" class="col-sm-2 col-xs-4 skin-blue-tip" href="">' +
        '</a>' +
        '<a data-skin="skin-blur-sunny" class="col-sm-2 col-xs-4 skin-sunny-tip" href="">' +
        '</a>' +
        '<a data-skin="skin-cloth" class="col-sm-2 col-xs-4 skin-cloth-tip" href="">' +
        '</a>' +
        '<a data-skin="skin-tectile" class="col-sm-2 col-xs-4 skin-tectile-tip" href="">' +
        '</a>' +
        '<a data-skin="skin-blur-chrome" class="col-sm-2 col-xs-4 skin-chrome-tip" href="">' +
        '</a>' +
        '<a data-skin="skin-blur-ocean" class="col-sm-2 col-xs-4 skin-ocean-tip" href="">' +
        '</a>' +
        '<a data-skin="skin-blur-sunset" class="col-sm-2 col-xs-4 skin-sunset-tip" href="">' +
        '</a>' +
        '<a data-skin="skin-blur-yellow" class="col-sm-2 col-xs-4 skin-yellow-tip" href="">' +
        '</a>' +
        '<a  data-skin="skin-blur-kiwi"class="col-sm-2 col-xs-4 skin-kiwi-tip" href="">' +
        '</a>' +
        '<a  data-skin="skin-blur-nexus"class="col-sm-2 col-xs-4 skin-nexus-tip" href="">' +
        '</a>' +
        '</div>' +
        '</div>' +
        '</div>' +
